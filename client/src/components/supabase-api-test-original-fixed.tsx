...
export default function SupabaseApiTestOriginalFixed() {
  ...
  // Form JSON data
  const [insertData, setInsertData] = useState('{"name": "Test Product", "description": "Created via secure API", "userId": 1}');
  const [updateData, setUpdateData] = useState('{"description": "Updated via secure API"}');
  const [updateFilters, setUpdateFilters] = useState('[{"column": "name", "operator": "eq", "value": "Test Product"}]');
  const [deleteFilters, setDeleteFilters] = useState('[{"column": "name", "operator": "eq", "value": "Test Product"}]');
